...
const Header = () => {
    ...
    const [menuSize, setMenuSize] = useState<number>(320);
    const [openBrandDrawer, setOpenBrandDrawer] = useState<boolean>(false);
    const [openFamilyDrawer, setOpenFamilyDrawer] = useState<boolean>(false);
    const [selectedBrand, setSelectedBrand] = useState<any>([]);
    const [selectedFamily, setSelectedFamily] = useState<any>([]);

    const handleOpenBrandDrawer = (brandData: any) => {
        setSelectedBrand(brandData);
        setOpenBrandDrawer(true);
    };
    const handleOpenFamilyDrawer = (familyData: any) => {
